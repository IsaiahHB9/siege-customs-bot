...
const SHOP_ITEMS = {
  ...
  rare_coin_bag: {
    ...
    rarity: 'Rare',
    price: 2500,
    description: 'Chest item redeemable for 100 MatchCoins.',
    buyable: false,
    chestOnly: true,
    giftable: true,
    type: 'coin',
  ...
  epic_coin_vault: {
    ...
    rarity: 'Epic',
    price: 15000,
    description: 'Chest item redeemable for 400 MatchCoins.',
    buyable: false,
    chestOnly: true,
    giftable: true,
    type: 'coin',
  ...
  mythic_coin_reserve: {
    ...
    rarity: 'Mythic',
    price: 125000,
    description: 'Chest item redeemable for 1000 MatchCoins.',
    buyable: false,
    chestOnly: true,
    giftable: true,
    type: 'coin',
  ...
  celestial_treasury: {
    ...
    rarity: 'Celestial',
    price: 250000,
    description: 'Chest item redeemable for 2000 MatchCoins.',
    buyable: false,
    chestOnly: true,
    giftable: true,
    type: 'coin',
